...
void* jpeg_get_small (j_common_ptr cinfo, size_t sizeofobject)
{
  //return (void *) malloc(sizeofobject);
   return (void *) IMAGE_MALLOC(sizeofobject);
}
...
void FAR *jpeg_get_large (j_common_ptr cinfo, size_t sizeofobject)
{
 ...
 #if 0
  return (void FAR *) IMAGE_MALLOC(sizeofobject);
 #else
  void FAR* data=  (void FAR *) IMAGE_MALLOC(sizeofobject);
  if(data == NULL && sizeofobject < 16*1024)
  	data= (void FAR *) IMAGE_MALLOC(16*1024);
  return data;
 #endif
}
