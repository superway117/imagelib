...
DumpScreen2Gif(const char *FileName,
    ...
    switch (ReqGraphDriver) {    /* Return on non supported screens. */
      ...
      case GIF_DUMP_SGI_WINDOW:
          ...
          RGBBuffer = (long *)IMAGE_MALLOC(sizeof(long) * ScreenXMax * ScreenYMax);
          readsource(SRC_FRONT);
          if (lrectread((short)0, (short)0, (short)(ScreenXMax - 1),
                        (short)(ScreenYMax - 1), RGBBuffer) !=
                 ScreenXMax * ScreenYMax) {    /* Get data. */
              IMAGE_FREE(RGBBuffer);
              return -1;
          }
          GlblGifBuffer = (GifByteType *) IMAGE_MALLOC(sizeof(GifByteType) *
    ...
    ScanLine = (GifPixelType *)IMAGE_MALLOC(sizeof(GifPixelType) * ScreenXMax);
...
QuantizeRGBBuffer(int Width,
    ...
    RedInput = (GifByteType *) IMAGE_MALLOC(sizeof(GifByteType) * Width * Height);
    GreenInput = (GifByteType *) IMAGE_MALLOC(sizeof(GifByteType) * Width * Height);
    BlueInput = (GifByteType *) IMAGE_MALLOC(sizeof(GifByteType) * Width * Height);
    ...
    IMAGE_FREE(RedInput);
    IMAGE_FREE(GreenInput);
    IMAGE_FREE(BlueInput);
